...
def parse_args():
    ...
    parser.add_argument('--weights_path', nargs='?', default='model_amazon/',
                        help='Store model path.')
    parser.add_argument('--pretrain_path', type=str, default='D:/NGCF-PyTorch-master/model_amazon/model_amazon_book.pth',
                        help='pretained model path')
    parser.add_argument('--data_path', nargs='?', default='D:/NGCF-PyTorch-master/Data/',
                        help='Input data path.')
    parser.add_argument('--proj_path', nargs='?', default='',
                        help='Project path.')

    parser.add_argument('--dataset', nargs='?', default='amazon_book',
                        help='Choose a dataset from {gowalla, yelp2018, amazon_book}')
